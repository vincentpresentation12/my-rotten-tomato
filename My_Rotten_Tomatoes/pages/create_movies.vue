<template>
   <div>
      <div class="text-center">
        <nuxt-link to="/movies_crud">Back</nuxt-link>
      </div><br/>
        <div class="col-md-12 form-wrapper">
            <h2> Create Movie </h2>
            <form id="create-post-form" @submit.prevent="createmovie()">
...
export default {
  ...
  methods: {
    createmovie() {
      ...
      this.__submitToServer(movieData);
    },
    
    __submitToServer(data) {
      axios.post("http://localhost:8080/api/movies", data).then(data => {
        return data
      },
